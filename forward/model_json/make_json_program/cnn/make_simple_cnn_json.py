...
def make_json():
    json_value = {
        "layer0":{"input_channels":1, "out_channels":32,"kernel_size":3,"layer_type":"input","processing_type":"cnn"},
        "layer1":{"input_channels":32, "out_channels":64,"kernel_size":3,"layer_type":"hidden","processing_type":"cnn"},
