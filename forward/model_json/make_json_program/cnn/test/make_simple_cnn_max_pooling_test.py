...
def make_json():
    json_value = {
        ...
        "layer1":{"input_channels":5, "out_channels":5,"stride":2,"layer_type":"hidden","processing_type":"max_pooling","skip_connection":0},
        "layer2":{"input_channels":5, "out_channels":7,"kernel_size":2,"layer_type":"hidden","processing_type":"cnn","skip_connection":0},
